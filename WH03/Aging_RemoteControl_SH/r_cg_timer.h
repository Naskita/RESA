...
#define _001F_TAU_TDR00_VALUE                   (0x001FU)
...
extern unsigned char US_count;
extern unsigned char Hundred_US_count;
extern unsigned char MS_count;
extern unsigned char Hundred_MS_count;
extern unsigned char Sec_count;
extern unsigned char Min_count;
extern unsigned char Hour_count;
extern unsigned char Day_count;
bit GetUsFlag(void);
bit GetMsFlag(void);
